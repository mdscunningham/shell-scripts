...
printf "$FMT" "Memory (Swap)" "$(free -m | awk '/Swap/ {print ($2/1000)"G / "($4/1000)"G ("($4/$2*100)"% Free)"}')"
...
INTERNAL=(172.17.192.119_r1bs-31.nexcess.net_208.69.120.91 172.17.192.117_r1bs-32.nexcess.net_208.69.120.106 172.17.192.115_r1bs-33.nexcess.net_208.69.120.108 172.17.192.113_r1bs-34.nexcess.net_208.69.120.241 172.17.192.111_r1bs-35.nexcess.net_208.69.120.110 172.17.192.109_r1bs-36.nexcess.net_208.69.120.112)
...
echo -e "\nGreetings,\n\nI have white-listed the requested IP address(es) ( $(for x in $HOST; do printf "$x, "; done)) for $TYPE access on $(serverName).\nYou should be all set. Please let us know if you need any further assistance.\n\nSincerely,\n"
}
